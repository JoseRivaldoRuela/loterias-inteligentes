...
export function PoolsPage() {
  ...
  async function submit() {
    ...
    try {
      await create.mutateAsync({ lotteryId: game.lotteryId, gameSetId: game.id, name, description, status, firstContestNumber: contestFrom, lastContestNumber: contestTo, totalShares: shares, participants: participants.map((item) => ({ ...item, shareCount: Number(item.shareCount) })), creatorParticipates })
